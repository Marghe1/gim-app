...
export const shareStrings: Strings = {
  en: {
    ...
    shareTitle: 'GymApp',
    shareMessage: 'Check out GymApp — a free, private workout tracker:',
    copied: 'Link copied!',
  ...
  it: {
    ...
    shareTitle: 'GymApp',
    shareMessage: 'Dai un’occhiata a GymApp — un diario di allenamento gratuito e privato:',
    copied: 'Link copiato!',
  ...
  fr: {
    ...
    shareTitle: 'GymApp',
    shareMessage: 'Découvre GymApp — un carnet d’entraînement gratuit et privé :',
    copied: 'Lien copié !',
    copyManually: 'Copie ce lien :',
  },
};
