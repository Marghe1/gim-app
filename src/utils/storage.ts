...
const defaultExercises: Exercise[] = [
  ...
  { id: '58', name: 'Straight Leg Bridge on Swiss Ball', muscleGroup: 'Glutes' },
  { id: '59', name: 'Single Leg Glute Bridge Hold', muscleGroup: 'Glutes' },
  { id: '60', name: 'Single Leg Balance with Kettlebell Round the World', muscleGroup: 'Core' },
  { id: '61', name: 'Dumbbell Single Leg Romanian Deadlift', muscleGroup: 'Legs' },
  { id: '62', name: 'Split Squat Hold with Kettlebell Pass Around', muscleGroup: 'Legs' },
  { id: '63', name: 'Single Leg Drop Jump with Stabilisation', muscleGroup: 'Plyometrics' },
  { id: '64', name: 'Box Step-Up', muscleGroup: 'Legs' },
  { id: '65', name: 'Pullover Crunch to Wall Throw', muscleGroup: 'Core' },
  { id: '66', name: 'Single Leg Hip Thrust', muscleGroup: 'Glutes' },
  { id: '67', name: "Landmine Meadow's Row to Power Press", muscleGroup: 'Full Body' },
  { id: '68', name: 'Farmers Walk', muscleGroup: 'Full Body' },
  { id: '69', name: 'Forward Plank on Swiss Ball', muscleGroup: 'Core' },
  { id: '70', name: 'Side Plank Clamshell', muscleGroup: 'Core' },
  { id: '71', name: 'Arch Body Hold', muscleGroup: 'Core' },
  { id: '72', name: 'Pogo Hop', muscleGroup: 'Plyometrics' },
  { id: '73', name: 'Drop Jump to Counter Movement Jump with Stabilisation', muscleGroup: 'Plyometrics' },
  { id: '74', name: 'Glute Bridge March', muscleGroup: 'Glutes' },
  { id: '75', name: 'Single Leg Balance on Upturned Bosu', muscleGroup: 'Core' },
  { id: '76', name: 'Single Leg Step Down', muscleGroup: 'Legs' },
  { id: '77', name: 'Deficit Bulgarian Split Squat', muscleGroup: 'Legs' },
];
...
const workoutTemplates: WorkoutTemplate[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'b1-4', exerciseId: '58', exerciseName: 'Straight Leg Bridge on Swiss Ball', targetSets: 3, targetReps: 20, restSeconds: 30 },
      { id: 'b1-5', exerciseId: '59', exerciseName: 'Single Leg Glute Bridge Hold', targetSets: 3, targetReps: 40, restSeconds: 30 },
      { id: 'b1-6', exerciseId: '60', exerciseName: 'Single Leg Balance with Kettlebell Round the World', targetSets: 3, targetReps: 20, restSeconds: 30 },
      { id: 'b1-7', exerciseId: '40', exerciseName: 'Drop Jump', targetSets: 3, targetReps: 8, restSeconds: 60 },
      { id: 'b1-8', exerciseId: '61', exerciseName: 'Dumbbell Single Leg Romanian Deadlift', targetSets: 3, targetReps: 10, restSeconds: 60 },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'b2-7', exerciseId: '62', exerciseName: 'Split Squat Hold with Kettlebell Pass Around', targetSets: 3, targetReps: 20, restSeconds: 30 },
      { id: 'b2-8', exerciseId: '63', exerciseName: 'Single Leg Drop Jump with Stabilisation', targetSets: 3, targetReps: 8, restSeconds: 60 },
      { id: 'b2-9', exerciseId: '64', exerciseName: 'Box Step-Up', targetSets: 3, targetReps: 8, restSeconds: 30 },
      { id: 'b2-10', exerciseId: '65', exerciseName: 'Pullover Crunch to Wall Throw', targetSets: 3, targetReps: 8, restSeconds: 60 },
      { id: 'b2-11', exerciseId: '66', exerciseName: 'Single Leg Hip Thrust', targetSets: 3, targetReps: 10, restSeconds: 30 },
      { id: 'b2-12', exerciseId: '67', exerciseName: "Landmine Meadow's Row to Power Press", targetSets: 3, targetReps: 8, restSeconds: 60 },
      { id: 'b2-13', exerciseId: '68', exerciseName: 'Farmers Walk', targetSets: 3, targetReps: 50, restSeconds: 60 },
    ],
    createdAt: '2026-06-14T00:00:00.000Z',
    updatedAt: '2026-06-14T00:00:00.000Z',
  },
  {
    ...
    category: 'PT Sessions',
    exercises: [
      { id: 'c1-1', exerciseId: '69', exerciseName: 'Forward Plank on Swiss Ball', targetSets: 3, targetReps: 60, restSeconds: 30 },
      { id: 'c1-2', exerciseId: '70', exerciseName: 'Side Plank Clamshell', targetSets: 3, targetReps: 12, restSeconds: 30 },
      { id: 'c1-3', exerciseId: '71', exerciseName: 'Arch Body Hold', targetSets: 3, targetReps: 50, restSeconds: 30 },
      { id: 'c1-4', exerciseId: '72', exerciseName: 'Pogo Hop', targetSets: 3, targetReps: 12, restSeconds: 45 },
      { id: 'c1-5', exerciseId: '73', exerciseName: 'Drop Jump to Counter Movement Jump with Stabilisation', targetSets: 3, targetReps: 8, restSeconds: 60 },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'c2-3', exerciseId: '74', exerciseName: 'Glute Bridge March', targetSets: 3, targetReps: 20, restSeconds: 30 },
      { id: 'c2-4', exerciseId: '75', exerciseName: 'Single Leg Balance on Upturned Bosu', targetSets: 2, targetReps: 60, restSeconds: 30 },
      { id: 'c2-5', exerciseId: '76', exerciseName: 'Single Leg Step Down', targetSets: 2, targetReps: 12, restSeconds: 30 },
      { id: 'c2-6', exerciseId: '61', exerciseName: 'Dumbbell Single Leg Romanian Deadlift', targetSets: 3, targetReps: 8, restSeconds: 60 },
      { id: 'c2-7', exerciseId: '77', exerciseName: 'Deficit Bulgarian Split Squat', targetSets: 3, targetReps: 8, restSeconds: 60 },
      { id: 'c2-8', exerciseId: '66', exerciseName: 'Single Leg Hip Thrust', targetSets: 3, targetReps: 12, restSeconds: 45 },
